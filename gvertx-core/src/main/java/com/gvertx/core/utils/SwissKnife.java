...
import com.gvertx.core.constant.GConstant;
...
public class SwissKnife {
    ...
    public static PropertiesConfiguration loadConfigurationInUtf8(String fileOrUrlOrClasspathUrl) {
        ...
        propertiesConfiguration.setEncoding(GConstant.UTF_8);
        propertiesConfiguration.setDelimiterParsingDisabled(true);
        propertiesConfiguration.setFileName(fileOrUrlOrClasspathUrl);
        propertiesConfiguration.getLayout().setSingleLine(GConstant.applicationSecret, true);
