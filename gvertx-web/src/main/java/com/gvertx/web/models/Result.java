...
package com.gvertx.web.models;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.gvertx.web.utils.DateUtil;
...
public class Result {
    ...
    public Result render(rx.Observable observable){
        if (this.observable == null) {
            this.observable = observable;
        }else{
            this.observable = this.observable.concatWith(observable);
        }
        return this;
    }
...
//        render(renderable);
    ...
    /**
     * Set the content type of this result to {@link Result#}.
     * 
     * @return the same result where you executed this method on. But the content type is now {@link Result#}.
     */
    public Result xml() {
